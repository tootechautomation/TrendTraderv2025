...
func pnlLoop(ctx context.Context) {
	...
	rFast := Region{X: anchor.Region.X + 20, Y: anchor.Region.Y + 8, W: anchor.Region.W + 37, H: anchor.Region.H - 10}
	rSlow := Region{X: anchor.Region.X + 20, Y: anchor.Region.Y - 15, W: anchor.Region.W + 37, H: anchor.Region.H - 10}
